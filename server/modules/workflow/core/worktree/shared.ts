...
const RUNTIME_TASK_ARTIFACT_EXACT_PATHS = new Set<string>(TASK_WORKSPACE_RUNTIME_ARTIFACT_EXACT_PATHS);
const RUNTIME_TASK_ARTIFACT_PREFIXES: string[] = [...TASK_WORKSPACE_RUNTIME_ARTIFACT_PREFIXES];
const RUNTIME_TASK_ARTIFACT_RESET_TARGETS: string[] = [...TASK_WORKSPACE_RUNTIME_ARTIFACT_RESET_TARGETS];
